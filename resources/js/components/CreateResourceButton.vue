<template>
  <div v-if="shouldShowButtons">
    ...
    <InertiaButton
      ...
      class="ml-4 flex-shrink-0 h-9 px-4 focus:outline-none ring-primary-200 dark:ring-gray-600 focus:ring text-white dark:text-gray-800 inline-flex items-center font-bold"
      dusk="create-button"
      :href="
